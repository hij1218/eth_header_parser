...
--    Connects eth_hdr_realign (SOF detection + alignment) to
--    eth_hdr_extract (field extraction FSM).
--    Input: 66-bit descrambled blocks at 312.5 MHz.
--    Output: per-field valid signals with minimum latency.
------------------------------------------------------------------------
library ieee;
